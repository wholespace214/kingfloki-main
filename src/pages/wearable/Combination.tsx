    ...
    <>
      <CombinationContainer>
        <CombinationWrapper>
          ...
          <CombinationDetails>
            <CombinationTitle>5 rarities, 6 categories, 2m+ combinations</CombinationTitle>
            <CombinationMiniTitle>SCARCITY AND TRAITS</CombinationMiniTitle>
            <CombinationContent>
              Our users will be able to find five different rarities (Common, Rare, Epic, Legendary and 1/1 pieces) and
              five different traits (hat, eyes, mouth, outfit, skin and special).
              <br />
              <br />
              The chances to pack wearables are proportional to their growth in rarity, the higher the rarity level the
              harder to find one of them in a single mint. <br />
              <br />
              For example, Rowan mints 20 times, he finds 10 common wearables, 6 rares, 3 epics, 1 legendary and none
              1/1 pieces. Aria mints 20 times, she finds 8 common wearables, 8 rares, 2 epics, 1 legendary and 1/1
              pieces. <br />
              <br />
              These randomised to the highest extents, allowing our users to try luck and improve their outfits as they
              mint.
            </CombinationContent>
          </CombinationDetails>
        </CombinationWrapper>
